...
/* ECL RECORD, DATASET, JOIN, and OUTPUT -- Write to Thor File(s) with OVERWRITE, and examine the File Position in OUTPUT */

/* Learning Outcome: 
        Create inline DATASETs with appropriate RECORD sets 
        Populate and JOIN
        Perform SORT 
        OUTPUT to Thor files 
        Examine the generated files via ECL Watch 
        Examine and learn the File Position and File pointers in Thor 
*/
...
// Write to a File1
// Uncompressed file 
OUTPUT(patientVisitInfoSort1,,'~ECL_Learning::MedFiles::in::patientVisitInfo_S1', OVERWRITE, THOR); 

// Write to a File2
// Compressed file 
OUTPUT(patientVisitInfoSort2,,'~ECL_Learning::MedFiles::in::patientVisitInfo_S2', THOR, COMPRESSED, OVERWRITE); 
